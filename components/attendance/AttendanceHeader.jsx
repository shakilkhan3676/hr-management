    ...
    <View style={styles.container}>
      ...
      <TouchableOpacity style={styles.monthContainer} onPress={() => setModalVisible(true)}>
        {startDate && endDate ? (
          ...
          <Text style={{ color: "black", fontSize: 10, fontWeight: "500" }}>This Month</Text>
        )}
      </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  monthContainer: { backgroundColor: "#C1CAC7", paddingHorizontal: 20, paddingVertical: 8, borderRadius: 40, alignSelf: "flex-start", marginTop: 30 }
});
